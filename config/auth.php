    ...
    'providers' => [
        ...
        'users' => [
            ...
            'database' => [
                 ...
                 *
                 * Password synchronization captures and hashes the users password upon login if
                 * they pass LDAP authentication. This helps in situations where you may want to
                 * provide a "back up" option in case your LDAP server is unreachable, as well as a way
                 * of determining if a users password is valid without having to call to your LDAP
                 * server and validate it for you.
                 *
                 */
                'sync_passwords' => true,
